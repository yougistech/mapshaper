...
export function LayerControl(gui) {
  ...
  function renderLayer(lyr, dataset, opts) {
    ...
    html += rowHTML('名称'/**'name'**/, '<span class="layer-name colored-text dot-underline">' + formatLayerNameForDisplay(lyr.name) + '</span>', 'row1');
    html += rowHTML('内容'/**'contents'**/, describeLyr(lyr));
