...
export function InteractionMode(gui) {
  ...
  var prompts = {
    box: '按住 Shift 键并拖动以绘制框', //'Shift-drag to draw a box',
    data: '单击并选择要素以编辑其属性', //'Click-select features to edit their attributes',
    selection: '单击并选择或按住 Shift 键拖动以选择要素', //'Click-select or shift-drag to select features'
  };

  // mode name -> menu text lookup
  var labels = {
    info: '探查要素', //'inspect features',
    box: '框选工具(按住 Shift 拖动)', //'shift-drag box tool',
    data: '编辑属性', //'edit attributes',
    labels: '位置标签', //'position labels',
    location: '拖动点', //'drag points',
    vertices: '编辑顶点', //'edit vertices',
    selection: '选择要素', //'select features',
    'add-points': '添加点', //'add points',
    off: '关闭', //'turn off'
  };
  var btn, menu;
  var _menuTimeout;
